export function ConverterParaDolar(ano: string, valorReais: string) {
  ...
  // Valor em dólar
  const valorDolar = valorNumber / taxa;

  // Formata o valor para que tenha uma formatação mais legível e duas casas após a vírgula
  ...
  return formatarValor.format(valorDolar);
}